...
const { AddDevotion, AddVerses, AddTopic, ApproveDevotion, UpdateDevotionLikes, UpdateDevotionDisLikes, PendingDevotions, ApprovedDevotions, ViewDevotionTopics, ViewDevotionTopicTitles, ViewDevotionSelectedTitle, ViewDevotionVerses } = require('../controllers/devotionalscontroller');
...
const { AddPoem, AddLines, AddAuthors, ApprovePoem, UpdateLikes, UpdateDisLikes, ViewPendingPoems, ViewApprovedPoems, ViewAllPoems, ViewAllAuthors, ViewAllTitles, ViewSelectedPoem, ViewSelectedTitle, ViewSelectedAuthorTitle } = require('../controllers/poemcontroller');
